...
void AddModFrame::OnSave(wxCommandEvent& event) {
   ...
   const char *query_update = "UPDATE MINERALS SET MINID=?, NAME=?, LOCALITY=?, LOCID_MNDAT=?, SIZE=?, WEIGHT=?, ACQUISITION=?, COLLECTION=?, VALUE=?, S1_SPECIES=?, S1_CLASS=?, S1_CHEMF=?, S1_COLOR=?, S1_FLSW=?, S1_FLMW=?, S1_FLLW=?, S1_FL405=?, S1_PHSW=?, S1_PHMW=?, S1_PHLW=?, S1_PH405=?, S1_TENEBR=?, S2_SPECIES=?, S2_CLASS=?, S2_CHEMF=?, S2_COLOR=?, S2_FLSW=?, S2_FLMW=?, S2_FLLW=?, S2_FL405=?, S2_PHSW=?, S2_PHMW=?, S2_PHLW=?, S2_PH405=?, S2_TENEBR=?, S3_SPECIES=?, S3_CLASS=?, S3_CHEMF=?, S3_COLOR=?, S3_FLSW=?, S3_FLMW=?, S3_FLLW=?, S3_FL405=?, S3_PHSW=?, S3_PHMW=?, S3_PHLW=?, S3_PH405=?, S3_TENEBR=?, S4_SPECIES=?, S4_CLASS=?, S4_CHEMF=?, S4_COLOR=?, S4_FLSW=?, S4_FLMW=?, S4_FLLW=?, S4_FL405=?, S4_PHSW=?, S4_PHMW=?, S4_PHLW=?, S4_PH405=?, S4_TENEBR=?, RADIOACT=?, COMMENTS=? WHERE MINID=?;";
    ...
    /* Bind all 63 inputs... */
    sqlite3_bind_text(stmt, ndx, entry_name->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_locality->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_locid->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_size->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_weight->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_acquisition->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_collection->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_value->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;

    sqlite3_bind_text(stmt, ndx, entry_s1_species->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_class->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_chemf->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_color->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_flsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_flmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_fllw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_fl405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_phsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_phmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_phlw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_ph405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s1_tenebr->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;

    sqlite3_bind_text(stmt, ndx, entry_s2_species->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_class->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_chemf->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_color->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_flsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_flmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_fllw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_fl405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_phsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_phmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_phlw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_ph405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s2_tenebr->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;

    sqlite3_bind_text(stmt, ndx, entry_s3_species->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_class->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_chemf->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_color->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_flsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_flmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_fllw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_fl405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_phsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_phmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_phlw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_ph405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s3_tenebr->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;

    sqlite3_bind_text(stmt, ndx, entry_s4_species->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_class->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_chemf->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_color->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_flsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_flmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_fllw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_fl405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_phsw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_phmw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_phlw->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_ph405->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_s4_tenebr->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;

    sqlite3_bind_text(stmt, ndx, entry_radioact->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
    sqlite3_bind_text(stmt, ndx, entry_comments->GetValue().ToStdString().c_str(), -1, SQLITE_TRANSIENT); ndx+=1;
...
void AddModFrame::PopulateForm(int uid) {
    ...
    int ndx = 0;
    entry_minid->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_name->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_locality->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_locid->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_size->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_weight->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_acquisition->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_collection->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_value->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;

    entry_s1_species->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_class->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_chemf->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_color->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_flsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_flmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_fllw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_fl405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_phsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_phmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_phlw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_ph405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s1_tenebr->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;

    entry_s2_species->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_class->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_chemf->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_color->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_flsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_flmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_fllw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_fl405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_phsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_phmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_phlw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_ph405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s2_tenebr->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;

    entry_s3_species->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_class->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_chemf->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_color->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_flsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_flmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_fllw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_fl405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_phsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_phmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_phlw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_ph405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s3_tenebr->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
   
    entry_s4_species->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_class->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_chemf->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_color->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_flsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_flmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_fllw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_fl405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_phsw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_phmw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_phlw->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_ph405->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
    entry_s4_tenebr->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;

    entry_radioact->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;

    entry_comments->AppendText(sqlite3_column_text(stmt, ndx)); ndx+=1;
